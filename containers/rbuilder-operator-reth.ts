...
// Pinned to what production runs: flashbots-images origin/trunk/buildernet
// (dc854ad, 2026-09-16) rbuilder-operator-rebalancer-downloader.service
...
// Production's eight ordering builders, verbatim from buildernet-configs
// network/production/shared/base.libsonnet builder_configs (2026-09-16).
...
// field, with devnet values where production has Builder Hub values; the

...
// tries can compute wrong roots here - live-hit 2026-09-16 with an in-process
// builder; ~1000 leaves give the trie branch nodes two to three levels deep.
// Bisection lever and mainnet-shape knob, not a fix.
//
...
function resolveRpcUrl(recipe: Recipe, name: string): string {
  ...
  // as when this runs inside the cluster); default is the local port-forward flow.
